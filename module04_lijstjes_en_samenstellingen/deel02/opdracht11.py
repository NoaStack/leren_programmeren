...
while True:
    keuze_kleur = input("Which color do you want? \nyellow\ngreen\norange\nyellow\nred\nbrown ")
...
if rond_kleuren > niet_rondkleuren:
...
if rond_kleuren == niet_rondkleuren:
    print(f" Er zijn {rond_teller}  en {niet_rond_teller} niet ronde vruchten in de kleur{keuze_kleur}")